            ...
            for (CSVRecord record : parser) {
                ...
                Brands brand = brandsRepo.findByBrandNameIgnoreCase(brandName)
                        .orElseGet(() -> {
                            ...
                            b.setBrandName(brandName);
                            b.setSlugName(generateSlug(brandName));
                            return brandsRepo.saveAndFlush(b); // <- zapis i od razu ID
                        });
...
// ----- PRODUCT -----
                ...
                productRepo.save(product); // <- wymusza zapis z ID powiązań
            }
        }
        }*/
   @Transactional
       ...
       try (
           ...
           for (CSVRecord record : parser) {
               ...
               if (brand == null) {
                   ...
                   brand.setSlugName(generateSlug(brandName));
                   brand = brandsRepo.saveAndFlush(brand);
               }
               ...
               if (category == null) {
                   ...
                   category.setSlugCategoryName(generateSlug(categoryName));
               ...
               if (subCategory == null) {
                   ...
                   subCategory.setSlugSubCategoryName(generateSlug(subCategoryName));
               ...
               if (brand.getBrandId() == null) {
                   throw new RuntimeException("Brand ID is NULL for: " + brandName);
               }
