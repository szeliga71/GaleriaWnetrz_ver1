...
public class ProductService {
    ...
    private void updateRelations(Product product, ProductDto dto) {
        if (dto.getCategoryName() != null) {
            product.setCategory(categoryRepo.findByCategoryNameIgnoreCase(dto.getCategoryName())
                    .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Category not found")));
        }
        if (dto.getSubCategoryName() != null) {
            product.setSubCategory(subCategoryRepo.findBySubCategoryNameIgnoreCase(dto.getSubCategoryName())
                    .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "SubCategory not found")));
        }
        if (dto.getBrandName() != null) {
            product.setBrand(brandsRepo.findByBrandNameIgnoreCase(dto.getBrandName())
